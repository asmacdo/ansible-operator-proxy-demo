...
# example.com/ansible-proxy-demo-bundle:$VERSION and example.com/ansible-proxy-demo-catalog:$VERSION.
IMAGE_TAG_BASE ?= quay.io/amacdona/ansible-proxy-demo
...
mitm: 
	kubectl apply -f config/mitm/mitm-pod.yaml
	kubectl apply -f config/mitm/mitm-service.yaml
...
ifeq (,$(shell which ansible-operator 2>/dev/null))
	...
	curl -sSLo $(ANSIBLE_OPERATOR) https://github.com/operator-framework/operator-sdk/releases/download/v1.8.2/ansible-operator_$(OS)_$(ARCH) ;\
